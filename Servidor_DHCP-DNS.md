...
Para asegurar el correcto funcionamiento, validamos la sintaxis del archivo de configuración general con sudo named-checkconf y la zona específica con sudo named-checkzone empresa.local /etc/bind/db.empresa.local, obteniendo un resultado correcto antes de reiniciar el servicio con sudo systemctl restart bind9. 

<img width="750" height="70" alt="image" src="https://github.com/user-attachments/assets/0be6c77c-beae-4ce8-a1c0-9e80b779616e" />

<img width="684" height="35" alt="image" src="https://github.com/user-attachments/assets/2c4dfadc-8a99-426d-a2fb-e9ee21a721c2" />

La comprobación final de la resolución la efectuamos con el comando nslookup www.empresa.local, que nos devolvió de manera correcta la dirección IP 192.168.10.11. 

<img width="659" height="175" alt="image" src="https://github.com/user-attachments/assets/bb06685b-ab76-4025-affd-682e968e4579" />
